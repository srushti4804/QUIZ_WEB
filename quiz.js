document.addEventListener("DOMContentLoaded", () => {
  ...
  function initializeQuiz() {
    ...
    console.log('Quiz initialized for subject:', subject, 'Score reset to:', score);
    return true;
}
...
if (!initializeQuiz()) return;
  ...
  function renderQuestion() {
    ...
    const progressPercentage = ((currentQuestionNum + 1) / questions.length) * 100;
    console.log(`Progress: ${progressPercentage}% for question ${currentQuestionNum + 1} of ${questions.length}`);
...
function updateButtons() {
    ...
    next_btn.textContent = currentQuestionNum === questions.length - 1 ? 'Finish' : 'Next';
}
...
animateProgress(progressElement, newDegrees, 500); // animate over 500ms
      ...
      setTimeout(()=>{
         ...
         <div class="result-container">
          ...
          <div class="circular-progress" style="--progress-degrees: ${percentage * 3.6}deg;">
            <div class="inner-circle">
              <Span class="percentage">${percentage}%</Span>
              <span class="score">You have scored ${score}/${questions.length} </span>
